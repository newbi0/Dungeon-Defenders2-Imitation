...
public:
	HRESULT Ready_Target(const _ulong& dwSizeX, const _ulong& dwSizeY, D3DFORMAT Format, D3DXCOLOR Color);
	...
	HRESULT SetUp_OnShader_Matrix(LPD3DXEFFECT pEffect, const char* pConstantName, const _matrix& matValue);
