...
class CHpBarBG_Boss final : public CUI
{
private:
	explicit CHpBarBG_Boss(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CHpBarBG_Boss(const CHpBarBG_Boss& rhs);
	virtual ~CHpBarBG_Boss(void) = default;
private:
...
public:
	static CHpBarBG_Boss* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
