...
class CUnit;
class CSkillBarBG_Boss final : public CUI
{
private:
	explicit CSkillBarBG_Boss(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CSkillBarBG_Boss(const CSkillBarBG_Boss& rhs);
	virtual ~CSkillBarBG_Boss(void) = default;
private:
...
private:
	...
	_float					m_fGageX = 0.f;
public:
	static CSkillBarBG_Boss* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
