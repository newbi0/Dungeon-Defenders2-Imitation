...
class CBossSkillAura final : public CSkill
{
private:
	explicit CBossSkillAura(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CBossSkillAura(const CBossSkillAura& rhs);
	virtual ~CBossSkillAura(void) = default;
private:
...
public:
	static CBossSkillAura* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
