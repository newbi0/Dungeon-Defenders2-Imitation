...
class CHealParticle final : public CSkill
{
private:
	explicit CHealParticle(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CHealParticle(const CHealParticle& rhs);
	virtual ~CHealParticle(void) = default;
private:
...
private:
	_float					m_fRot = 0.f;
	_float					m_fOriginHight = 0.f;
public:
	static CHealParticle* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
