...
class CUnit;
class CHpBar_Enemy final : public CUI
{
private:
	explicit CHpBar_Enemy(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CHpBar_Enemy(const CHpBar_Enemy& rhs);
	virtual ~CHpBar_Enemy(void) = default;
private:
...
private:
	...
	_float					m_fHpX = 0.f;
public:
	static CHpBar_Enemy* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
