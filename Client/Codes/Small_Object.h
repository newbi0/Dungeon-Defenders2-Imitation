...
class CSmall_Object final : public CGameObject
{
private:
	explicit CSmall_Object(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CSmall_Object(const CSmall_Object& rhs);
	virtual ~CSmall_Object(void) = default;
private:
...
public:
	static CSmall_Object* Create(LPDIRECT3DDEVICE9 pGraphic_Device, const _tchar* pMashTag);
