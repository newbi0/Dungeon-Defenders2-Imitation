...
class CPlaneObject final : public CGameObject
{
private:
	explicit CPlaneObject(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CPlaneObject(const CPlaneObject& rhs);
	virtual ~CPlaneObject(void) = default;
private:
...
public:
	static CPlaneObject* Create(LPDIRECT3DDEVICE9 pGraphic_Device, const _tchar* pMashTag);
